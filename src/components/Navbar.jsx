...
const Navbar = () => { 
  ...
  return (
    ...
    <div class={`flex w-full px-[30px] h-[76px] 2xl:px-10 sm:px-[60px] md:px-[32px] ${fondo}`}>
      <div class={`flex justify-between m-auto  h-[76px] px-0 items-center w-[1468px] gap-[15px] p-[16px] 2xl:px-[64px] xl:px-[60px] lg:px-[10px] md:px-[32px] sm:px-0 ${fondo}`}>
        {/* LOGO */}
        <div class="flex gap-1 h-[30px] flex-row text-left w-[70px] justify-between content-center items-center">
          ...
          <img class="w-full h-full" src="/public/img/logo_sinfondo.png" alt="Logo" />
          {/* <div >
        ...
        <div class="relative flex gap-4 h-15 flex-row text-center mx-0 items-center ">
          {localStorage.getItem("token") && (
            <button onClick={handlePanel} class="!bg-[#FEF7F2] !text-[#0e0d0d] !p-1 rounded-sm cursor-pointer shadow-sm shadow-black" >
              Administrador
            </button>
          )}
