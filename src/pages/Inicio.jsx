  ...
  return (
    <div class="m-0 box-border text-base h-[100vw] bg-[#FEF7F2] ">
      ...
      <main id="Propiedades" class="flex justify-center bg-[#FEF7F2]">
        {/* px-[16px] items-center mx-[32px] ---md:mx-[60px]*/}
        <section class=" py-[32px] max-w-[1468px] h-[100%] bg-[#FEF7F2] m-auto flex justify-center flex-col xl:px-[64px] lg:px-[16px]">
          <div class="w-[100%] max-h-[48px] flex justify-center py-1 mb-10 items-center 2xl:px-5 2xl:w-[1440px] xl:w-[100%] xl:px-0 md:px-0 md:w-[100%] lg:w-[100%] sm:px-5 bg-[#FEF7F2] lg:px-0 ">
            <svg
